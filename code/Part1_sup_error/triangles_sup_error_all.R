...
for(kk in 1:15){
  ...
  for(ii in 1:30){
    ...
    for(jj in 1:B){
      ...
      tri_mb[ii,jj]= num_tri_tot/(choose(n,3)*c_hat^3*tau_n^3)+(sum_eA_tri-sum_center_T)/(choose(n,3)*c_hat^3*tau_n^3)
      print(c(kk,ii,jj))
    }
    ed=Sys.time()
    tiktok_gauprod[kk,ii]=ed-st
    
    Tmb_gauprod=(tri_mb[ii,]-mean(tri_mb[ii,]))/Sn_hat_formb #sqrt(var(tri_mb[ii,]))#Sn_hat_formb
    # if center at tnhat here would be
    # Tmb_gauprod=(tri_mb[ii,]-tri_hat[kk,ii])/Sn_hat_formb 
    ...
    Tmb_linqua=(tri_mb[ii,]-mean(tri_mb[ii,]))/Sn_hat_formb 
    # if center at tnhat here would be
    # Tmb_linqua=(tri_mb[ii,]-tri_hat[kk,ii])/Sn_hat_formb 
    ...
    Tmb_add=(tri_mb[ii,]-mean(tri_mb[ii,]))/Sn_hat_formb #sqrt(var(tri_mb[ii,]))#Sn_hat_formb
    # if center at tnhat here would be
    # Tmb_add=(tri_mb[ii,]-tri_hat[kk,ii])/Sn_hat_formb 
    ...
    for(jj in 1: B) {
      tri_mb[ii,jj]=  trihat_lz+ 3*(sum(W[,jj]*h1_lz)/n- trihat_lz) 
      print(c(kk,ii,jj))
    }
    ed=Sys.time()
    tiktok_lz[kk,ii]=ed-st
    
    Tmb_lz=(tri_mb[ii,]-mean(tri_mb[ii,]))/Sn_hat_lz 
    # if center at tnhat here would be
    # Tmb_lz=(tri_mb[ii,]-tri_hat[kk,ii])/Sn_hat_lz 
    ...
    Tmb_sub=(tri_mb[ii,]-mean(tri_mb[ii,]))/mean(Sn_hat_formbsb*sqrt(b/n))  #sqrt(var(tri_mb[ii,]))#Sn_hat_formb
    # if center at tnhat here would be
    #Tmb_sub=(tri_mb[ii,]-tri_hat[kk,ii])/mean(Sn_hat_formbsb*sqrt(b/n))
    ...
    Tmb_eg=(tri_mb[ii,]-mean(tri_mb[ii,]))/Sn_hat_formb #sqrt(var(tri_mb[ii,]))#Sn_hat_formb
    # if center at tnhat here would be
    # Tmb_eg=(tri_mb[ii,]-tri_hat[kk,ii])/Sn_hat_formb
    ...
    Tmb_us=(TnLboot_us[ii,]-mean(TnLboot_us[ii,]))/Sn_hat_formb_us #sqrt(var(tri_mb[ii,]))#Sn_hat_formb
    #if center at Tnhat here would be
    ...
    Tmb_kato=(TnLboot_kato[ii,]-mean(TnLboot_kato[ii,]))/Sn_hat_formb_kato #sqrt(var(tri_mb[ii,]))#Sn_hat_formb
    #if center at Tnhat here would be
